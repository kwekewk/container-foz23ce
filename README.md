...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-foz23ce.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-foz23ce.containers.anotherwebservice.com/
...
```
git clone git@github.com:kwekewk/container-foz23ce.git
cd container-foz23ce
```
...
```
docker attach container-foz23ce
```
